...
public class ToBinary {
    ...
    public static void digitList(int i) {
        ...
        //5. reorder the digits in the reverse order; i.e. the final remainder becomes the MSB, and the first reminder becomes LSB.
    ...
    public static void negativeDigits(int i) {
        ...
        //7. reorder the digits in the reverse order; i.e. the final remainder becomes the MSB, and the first reminder becomes LSB.
